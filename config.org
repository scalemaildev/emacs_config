...
* Introduction
This is John Conway's Emacs configuration (mostly stolen from Runemacs). This will work on Windows,
OSX, and Linux with some minor fiddling.
- Started: 12/20/2018
...
4. Compile the auto-tangle for configuration files section
5. Restart and download all packages
6. Restart again to ensure everything is running smoothly
7. Enjoy~
