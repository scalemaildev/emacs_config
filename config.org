...
** Setup
1. Install [[https://madmalik.github.io/mononoki/][Mononoki]] font and the fonts that come from /All the Icons/
...
#+begin_src emacs-lisp
  (defvar configorg/default-font-size 175) ;; default font size
  (defvar configorg/default-variable-font-size 175) ;; size of variable font  
#+end_src
