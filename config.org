...
** Requirements
This configuration uses [[https://madmalik.github.io/mononoki/][Mononoki]] font. Also, make sure to run /(all-the-icons-install-fonts)/ on a fresh setup. On Windows, the .tff files will need to be manually installed
